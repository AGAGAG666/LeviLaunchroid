...
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeInit(JNIEnv* env, jclass clazz) {
    if (g_initialized) {
        return JNI_TRUE;
    }
...
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeOnKeyDown(JNIEnv* env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeOnKeyUp(JNIEnv* env, jclass clazz) {
    if (!g_initialized || !g_zoomKeyDown) return;
...
JNIEXPORT void JNICALL
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeOnScroll(JNIEnv* env, jclass clazz, jfloat delta) {
    if (!g_initialized || !g_zoomKeyDown) return;
...
JNIEXPORT void JNICALL
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeSetAnimated(JNIEnv* env, jclass clazz, jboolean animated) {
    g_animated = animated;
}

JNIEXPORT jboolean JNICALL
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeIsZooming(JNIEnv* env, jclass clazz) {
    return g_zoomKeyDown ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT void JNICALL
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeSetZoomLevel(JNIEnv* env, jclass clazz, jlong level) {
    g_zoomLevel = static_cast<uint64_t>(level);
}

JNIEXPORT jlong JNICALL
Java_org_levimc_launcher_mom_core_mods_inbuilt_nativemod_ZoomMod_nativeGetZoomLevel(JNIEnv* env, jclass clazz) {
