...
import org.levimc.launcher.mom.core.content.ContentImporter;
import org.levimc.launcher.mom.core.curseforge.CurseForgeClient;
import org.levimc.launcher.mom.core.curseforge.models.Content;
import org.levimc.launcher.mom.core.curseforge.models.ContentFile;
...
public class ContentDetailsActivity extends BaseActivity {
    ...
    private void loadAllFiles() {
        ...
        client.getModFiles(content.id, 0, 50, new CurseForgeClient.CurseForgeCallback<>() {
            @Override
            public void onSuccess(org.levimc.launcher.mom.core.curseforge.models.ModFilesResponse result) {
                runOnUiThread(() -> {
    ...
    private void showFilesDialog(java.util.List<ContentFile> files) {
        ...
        org.levimc.launcher.mom.ui.adapter.FileListAdapter adapter = new org.levimc.launcher.mom.ui.adapter.FileListAdapter(file -> {
            dialog.dismiss();
    ...
    private File getPackDirectory(String packType) {
        ...
        org.levimc.launcher.mom.settings.FeatureSettings.StorageType currentStorageType = org.levimc.launcher.mom.settings.FeatureSettings.StorageType.valueOf(savedType);
