package org.levimc.launcher.mom.ui.activities;
...
import org.levimc.launcher.mom.core.minecraft.MinecraftImportIntents;
import org.levimc.launcher.mom.core.minecraft.LaunchTrace;
import org.levimc.launcher.mom.core.minecraft.MinecraftLauncher;
import org.levimc.launcher.mom.core.mods.FileHandler;
import org.levimc.launcher.mom.core.mods.Mod;
import org.levimc.launcher.mom.core.mods.inbuilt.manager.InbuiltModManager;
import org.levimc.launcher.mom.core.versions.GameVersion;
import org.levimc.launcher.mom.core.versions.VersionManager;
import org.levimc.launcher.mom.databinding.ActivityMainBinding;
import org.levimc.launcher.mom.settings.FeatureSettings;

import org.levimc.launcher.mom.ui.animation.DynamicAnim;
import org.levimc.launcher.mom.ui.dialogs.CustomAlertDialog;
import org.levimc.launcher.mom.ui.dialogs.PlayStoreValidationDialog;
import org.levimc.launcher.mom.ui.views.MainViewModel;
import org.levimc.launcher.mom.ui.views.MainViewModelFactory;
import org.levimc.launcher.mom.util.ApkImportManager;
import org.levimc.launcher.mom.util.GithubReleaseUpdater;
import org.levimc.launcher.mom.util.LanguageManager;
import org.levimc.launcher.mom.util.PermissionsHandler;
import org.levimc.launcher.mom.util.PersonalizationManager;
import org.levimc.launcher.mom.util.PlayStoreValidator;
import org.levimc.launcher.mom.util.ResourcepackHandler;
import org.levimc.launcher.mom.util.UIHelper;
import org.levimc.launcher.mom.core.content.ContentManager;
...
import okhttp3.OkHttpClient;
 ...
 import org.levimc.launcher.mom.core.auth.MsftAccountStore;
 import org.levimc.launcher.mom.core.auth.MsftAuthManager;
 import org.levimc.launcher.mom.ui.dialogs.LoadingDialog;
 import org.levimc.launcher.mom.util.AccountTextUtils;
 import org.levimc.launcher.mom.util.DialogUtils;

 import static org.levimc.launcher.mom.core.minecraft.MinecraftProcessRestarterKt.ACTION_MAIN_ACTIVITY_FIRST_DRAWN;
 import static org.levimc.launcher.mom.core.minecraft.MinecraftProcessRestarterKt.EXTRA_CLOSE_RESTART_ACTIVITY_ON_FIRST_DRAW;
 ...
 public class MainActivity extends BaseActivity {
        ...
        accountLoginLauncher = registerForActivityResult(new androidx.activity.result.contract.ActivityResultContracts.StartActivityForResult(), result -> {
            if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                ...
                if (code != null && codeVerifier != null) {
                    accountLoadingDialog = org.levimc.launcher.mom.util.DialogUtils.ensure(this, accountLoadingDialog);
                    org.levimc.launcher.mom.util.DialogUtils.showWithMessage(accountLoadingDialog, getString(R.string.ms_login_exchanging));

                    accountExecutor.execute(() -> {
                        okhttp3.OkHttpClient client = new okhttp3.OkHttpClient();
                        try {
                            OAuth20Token token =MsftAuthManager.exchangeCodeForToken(client, org.levimc.launcher.mom.core.auth.MsftAuthManager.DEFAULT_CLIENT_ID, code, codeVerifier, org.levimc.launcher.mom.core.auth.MsftAuthManager.DEFAULT_SCOPE + " offline_access");
     ...
     private void setupOnBackPressedCallback() {
         onBackPressedCallback = new OnBackPressedCallback(true) {
             ...
             public void handleOnBackPressed() {
                 org.levimc.launcher.mom.ui.dialogs.CustomAlertDialog exitDialog = new org.levimc.launcher.mom.ui.dialogs.CustomAlertDialog(MainActivity.this);
                 exitDialog.setTitleText(getString(org.levimc.launcher.mom.R.string.dialog_title_exit_app))
                         .setMessage(getString(org.levimc.launcher.mom.R.string.dialog_message_exit_app))
                         .setPositiveButton(getString(org.levimc.launcher.mom.R.string.dialog_positive_exit), v -> {
                             exitDialog.dismissImmediately();
                             finishAffinity();
                         })
                         .setNegativeButton(getString(org.levimc.launcher.mom.R.string.dialog_negative_cancel), null)
                         .show();
             }
         };
    ...
    private void initModsSection() {
        ...
        org.levimc.launcher.mom.util.PersonalizationManager pm = new org.levimc.launcher.mom.util.PersonalizationManager(this);
    ...
    private void refreshContentCounts() {
        ...
        org.levimc.launcher.mom.settings.FeatureSettings.StorageType storageType;
        try {
            storageType = org.levimc.launcher.mom.settings.FeatureSettings.StorageType.valueOf(savedType);
        } catch (IllegalArgumentException e) {
            storageType = org.levimc.launcher.mom.settings.FeatureSettings.StorageType.INTERNAL;
        }
    ...
    private void updateModsUI(List<Mod> mods) {
        ...
        if (!manager.isModMenuEnabled()) {
            for (org.levimc.launcher.mom.core.mods.inbuilt.model.InbuiltMod inbuilt : manager.getAddedMods(this)) {
