...
public class VirtualCursorMod {
    ...
    private static void setCursorVisible(boolean visible, Activity activity) {
        if (visible) {
            if (cursorView == null && activity != null) {
                ...
                cursorView.setImageResource(org.levimc.launcher.mom.R.drawable.ic_virtual_cursor);
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (event.getHistorySize() > 0) {
                    ...
                    float sensitivity = org.levimc.launcher.mom.core.mods.inbuilt.manager.InbuiltModManager.getInstance(activity).getCursorSensitivity() / 100f;
    ...
    private static void sendHoverMove(Activity activity, float x, float y, long time) {
        ...
        try {
            if (activity instanceof org.levimc.launcher.mom.core.minecraft.MinecraftActivity) {
                ((org.levimc.launcher.mom.core.minecraft.MinecraftActivity) activity).dispatchGenericMotionEventToGame(hoverEvent);
            }
        } catch (Exception ignored) {}
        hoverEvent.recycle();
    }
    ...
    private static void sendClick(Activity activity, float x, float y, long time) {
        ...
        try {
            if (activity instanceof org.levimc.launcher.mom.core.minecraft.MinecraftActivity) {
                ((org.levimc.launcher.mom.core.minecraft.MinecraftActivity) activity).dispatchTouchEventToGame(downEvent);
            }
        } catch (Exception ignored) {}
        downEvent.recycle();
        ...
        try {
            if (activity instanceof org.levimc.launcher.mom.core.minecraft.MinecraftActivity) {
                ((org.levimc.launcher.mom.core.minecraft.MinecraftActivity) activity).dispatchTouchEventToGame(upEvent);
            }
        } catch (Exception ignored) {}
        upEvent.recycle();
    }
