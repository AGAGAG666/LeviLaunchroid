...
import org.levimc.launcher.mom.core.minecraft.MinecraftActivity;
import org.levimc.launcher.mom.core.minecraft.MinecraftActivityState;
import org.levimc.launcher.mom.core.minecraft.MinecraftImportIntents;
import org.levimc.launcher.mom.util.MinecraftUriHandler;
    ...
    private void handleDeepLink(Intent originalIntent) {
        ...
        if (isMinecraftActivityRunning()) {
            ...
            if (isMcRunning()) {
                ...
                newIntent.setClassName(this, "org.levimc.launcher.mom.ui.activities.MainActivity");
            }
        }
