...
import org.levimc.launcher.mom.ui.adapter.AccountsAdapter;
...
import org.levimc.launcher.mom.core.auth.storage.XalStorageManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
            if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                ...
                if (code != null && codeVerifier != null) {
                    ...
                    loadingDialog = org.levimc.launcher.mom.util.DialogUtils.ensure(this, loadingDialog);
                    org.levimc.launcher.mom.util.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_exchanging));
                    ...
                    executor.execute(() -> {
                        ...
                        try {
                            ...
                            runOnUiThread(() -> org.levimc.launcher.mom.util.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_auth_xbox_device)));
                            MsftAuthManager.XboxAuthResult xbox = MsftAuthManager.performXboxAuth(client, token, this);

                            runOnUiThread(() -> org.levimc.launcher.mom.util.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_fetch_minecraft_identity)));
        ...
        adapter.setOnAccountActionListener(new AccountsAdapter.OnAccountActionListener() {
            ...
            public void onSetActive(MsftAccountStore.MsftAccount account) {
                ...
                if (withinSevenDays) {
                    runOnUiThread(() -> {
                        org.levimc.launcher.mom.util.DialogUtils.dismissQuietly(loadingDialog);
                ...
                loadingDialog = org.levimc.launcher.mom.util.DialogUtils.ensure(AccountsActivity.this, loadingDialog);
                org.levimc.launcher.mom.util.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_auth_xbox_device));
