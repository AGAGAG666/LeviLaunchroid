...
public class MinecraftLauncher {
    ...
    public static final String EXTRA_GAME_VERSION = "org.levimc.launcher.mom.extra.GAME_VERSION";
    ...
    public void launch(Intent sourceIntent, GameVersion version, LaunchCallback callback) {
        ...
        try {
                    ...
                    if (parts.length >= 2) {
                        ...
                        if (major < 1 || (major == 1 && minor < 21) || (major == 1 && minor == 21 && patch < 80)) {
                            activity.runOnUiThread(() -> {
                                new org.levimc.launcher.mom.ui.dialogs.CustomAlertDialog(activity)
                                        .setTitleText(activity.getString(org.levimc.launcher.mom.R.string.unsupported_version_title))
                                        .setMessage(activity.getString(org.levimc.launcher.mom.R.string.unsupported_version_msg))
                                        .setPositiveButton(activity.getString(org.levimc.launcher.mom.R.string.back), null)
                                        .show();
                            });
            ...
            if (version.needsRepair) {
                activity.runOnUiThread(() ->
                        org.levimc.launcher.mom.core.versions.VersionManager.attemptRepairLibs(activity, version)
                );
