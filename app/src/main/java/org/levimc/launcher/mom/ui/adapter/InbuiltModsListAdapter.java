package org.levimc.launcher.mom.ui.adapter;
...
public class InbuiltModsListAdapter extends RecyclerView.Adapter<InbuiltModsListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        int iconRes = org.levimc.launcher.mom.ui.util.InbuiltModConfigHelper.getModIcon(mod.getId());
        holder.icon.setImageResource(iconRes);
        holder.icon.setImageTintList(null);
        holder.icon.setBackgroundTintList(null);

        holder.settingsButton.setOnClickListener(v -> org.levimc.launcher.mom.ui.util.InbuiltModConfigHelper.showConfigDialog(context, mod, modId -> {
            org.levimc.launcher.mom.core.mods.inbuilt.overlay.InbuiltOverlayManager overlayManager = org.levimc.launcher.mom.core.mods.inbuilt.overlay.InbuiltOverlayManager.getInstance();
        ...
        org.levimc.launcher.mom.util.PersonalizationManager pm = new org.levimc.launcher.mom.util.PersonalizationManager(context);
