package org.levimc.launcher.mom.core.auth.storage;
...
import org.levimc.launcher.mom.core.auth.AuthConfig;
...
public class XalStorageManager {
    ...
    public static File getMsaTokenFile(Context ctx, String userId) {
        String tid = org.levimc.launcher.mom.core.auth.AuthConfig.productionRetailJwtDefault().defaultTitleTid();
