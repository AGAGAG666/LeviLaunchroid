...
public class MsftLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        codeVerifier = org.levimc.launcher.mom.util.CryptoUtils.generateCodeVerifier();
        state = org.levimc.launcher.mom.util.CryptoUtils.randomString(32);

        String url = MsftAuthManager.buildAuthorizeUrl(CLIENT_ID, SCOPE, org.levimc.launcher.mom.util.CryptoUtils.urlSafeBase64(org.levimc.launcher.mom.util.CryptoUtils.sha256(codeVerifier)), state);
        webView.loadUrl(url);
    }
