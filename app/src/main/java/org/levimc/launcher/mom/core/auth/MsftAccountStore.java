package org.levimc.launcher.mom.core.auth;
...
import org.levimc.launcher.mom.util.JsonIOUtils;
...
public class MsftAccountStore {
    ...
    public static synchronized void remove(Context ctx, String id) {
        ...
        if (removed != null && removed.msUserId != null && !removed.msUserId.isEmpty()) {
            try {
                org.levimc.launcher.mom.core.auth.storage.XalStorageManager.deleteUserDir(ctx, removed.msUserId);
