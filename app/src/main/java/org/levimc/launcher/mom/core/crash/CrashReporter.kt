package org.levimc.launcher.mom.core.crash
...
import org.levimc.launcher.mom.BuildConfig
import org.levimc.launcher.mom.settings.FeatureSettings
import org.levimc.launcher.mom.ui.activities.CrashActivity
import java.io.File
...
object CrashReporter {
    ...
    private fun isMinecraftActivity(activity: Activity): Boolean {
        return activity.javaClass.name == "org.levimc.launcher.mom.core.minecraft.MinecraftActivity" ||
            activity.javaClass.name == "org.levimc.launcher.mom.core.minecraft.MinecraftLoadingActivity"
    }
