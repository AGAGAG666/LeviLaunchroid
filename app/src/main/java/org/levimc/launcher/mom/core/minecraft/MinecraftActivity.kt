package org.levimc.launcher.mom.core.minecraft
...
import org.levimc.launcher.mom.core.crash.CrashReporter
import org.levimc.launcher.mom.core.mods.inbuilt.overlay.InbuiltOverlayManager
import java.io.File
...
class MinecraftActivity : MainActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        org.levimc.launcher.mom.preloader.PreloaderInput.setActivity(this)
    ...
    override fun dispatchKeyEvent(event: KeyEvent): Boolean {
        ...
        if (event.action == KeyEvent.ACTION_UP) {
            if (org.levimc.launcher.mom.preloader.PreloaderInput.onKeyEvent(event.keyCode, unicodeChar, false)) {
                return true
            }
        }

        if (event.action == KeyEvent.ACTION_DOWN) {
            if (org.levimc.launcher.mom.preloader.PreloaderInput.onKeyEvent(event.keyCode, unicodeChar, true)) {
                return true
            }
        }
    ...
    override fun dispatchTouchEvent(event: MotionEvent): Boolean {
        ...
        if (org.levimc.launcher.mom.preloader.PreloaderInput.onTouch(
                event.actionMasked,
        ...
        if (org.levimc.launcher.mom.core.mods.inbuilt.overlay.VirtualCursorMod.isActive()) {
            org.levimc.launcher.mom.core.mods.inbuilt.overlay.VirtualCursorMod.processTouchEvent(event, this)
            return true
        }
    ...
    override fun onDestroy() {
        ...
        org.levimc.launcher.mom.preloader.PreloaderInput.clearActivity()
